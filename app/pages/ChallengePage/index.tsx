...
const ChallengePage = () => {
  return (
    <div className="w-[94%] mx-auto flex flex-col items-center">
      <div className="pl-2 sm:pl-0 max-w-[65%] sm:max-w-none mr-auto sm:mr-0 mt-[72.5px] font-medium text-2xl sm:text-4xl leading-[43px] sm:leading-[60px] bg-gradient-to-r from-gray-900 to-gray-900 bg-clip-text text-transparent">
